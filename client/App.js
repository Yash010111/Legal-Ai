...
export default function App() {
  ...
  const sendMessage = async () => {
    ...
    // Send to serverUrl; expect JSON response {reply: '...'} or plain text
    try {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.urlRow}>
        <TextInput style={styles.urlInput} value={urlEdit} onChangeText={setUrlEdit} placeholder="Enter server URL (e.g. http://localhost:8000/chat)" />
